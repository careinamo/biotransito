...
require_once(dirname(__FILE__) . '/includes/class.bcn_breadcrumb.php');
//Include the breadcrumb trail class
require_once(dirname(__FILE__) . '/includes/class.bcn_breadcrumb_trail.php');
if(class_exists('WP_Widget'))
{
	//Include the WP 2.8+ widget class
	require_once(dirname(__FILE__) . '/includes/class.bcn_widget.php');
}
...
class breadcrumb_navxt
{
	...
	public function __construct(bcn_breadcrumb_trail $breadcrumb_trail)
	{
		...
		{
			require_once(dirname(__FILE__) . '/includes/class.bcn_network_admin.php');
		...
		{
			require_once(dirname(__FILE__) . '/includes/class.bcn_admin.php');
			//Instantiate our new admin object
...
//        );
//	    $use_opt = array();
//	    foreach ($use_opt_keys as $key)
//        {
//            $use_opt[$key] = (isset($opt[$key])) ? $opt[$key] : '';
//        }
//
//        echo "<pre>";
//        var_dump([$use_opt,$opt]);die();
