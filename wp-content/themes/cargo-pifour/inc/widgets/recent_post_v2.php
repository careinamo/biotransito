...
class CS_Recent_Post_Widget_V2 extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'cs_recent_post_v2',esc_html__( 'CS Recent Posts', 'cargo-pifour' ),array('description' => esc_html__( 'Recent Posts Widget.', 'cargo-pifour' )) 
        );
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? esc_html__('Recent Posts', 'cargo-pifour' ) : $instance['title'], $instance, $this->id_base);
                ...
                <div class="cms-recent-post">
                    <div class="cms-recent-post-wrapper">
                        ...
                        <div class="widget-recent-item clearfix">
                            ...
                            $thumbnail = get_the_post_thumbnail(get_the_ID(),'cargo-pifour-580-540');
                            ?>
                           ...
                           <?php
                            }else if( !has_post_thumbnail() && $show_image){
                           ...
                           <?php
                            ...
                            ?>
                                ...
                                <div class="entry-main">
                                    <h6 class="title-recent"><a class="entry-title" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h6>
                                    <?php if ($show_date) { ?>
                                    <span class="date"><i class="flaticon-null"></i><?php echo get_the_date();?></span>
                                    <?php }?>
                                    ...
                                    <?php
                                      if($show_comment) :
                                        if ( comments_open() ) :
                                            comments_popup_link(
                                              esc_html__('Leave a Comment', 'cargo-pifour'),
                                              esc_html__('One Comment', 'cargo-pifour'),
                                              esc_html__('% Comments', 'cargo-pifour'),
                                              esc_html__('Read all Comments', 'cargo-pifour')
                                             );
                                    ...
                                    <?php if ($show_decs) { ?>
                                        <div class="description"><?php echo cargo_pifour_grid_limit_words( strip_tags( get_the_excerpt() ),6); ?></div>
                                    <?php  } ?>
                                </div>
                            </div> 
                        <?php endwhile; ?>
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>"><?php esc_html_e( 'Show date:', 'cargo-pifour' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_decs')); ?>"><?php esc_html_e( 'Show Description:', 'cargo-pifour' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_image')); ?>"><?php esc_html_e( 'Show Image:', 'cargo-pifour' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_comment')); ?>"><?php esc_html_e( 'Show Comment:', 'cargo-pifour' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e( 'Number of products to show:', 'cargo-pifour' ); ?></label>
