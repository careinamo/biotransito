...
<div id="header_middle" class="header-middle">
    <div class="container">
        <div class="header-middle-wrap">
            <?php if ( is_active_sidebar( 'header-middle-3-left' )  ) : ?>
            <div class="header-middle-left hidden-xs hidden-sm hidden-md">
                <?php dynamic_sidebar('header-middle-3-left'); ?>
            </div>
            <?php endif;?>
            ...
            <?php if ( is_active_sidebar( 'header-middle-3-right' )  ) : ?>
            <div class="header-middle-right hidden-xs hidden-sm hidden-md">
                <?php dynamic_sidebar('header-middle-3-right'); ?>
            </div>
            <?php endif;?>
        </div> 
    </div>
        ...
        <div class="container">
            <div class="main-header-outer">
                <div id="cshero-header-navigation" class="header-navigation ">
                    ...
                    <?php if ( is_active_sidebar( 'menu-sidebar3' )  ) : ?>
                    <div class="menu-sidebar-list hidden-xs hidden-sm hidden-md">
                        <?php dynamic_sidebar('menu-sidebar3'); ?>
                    </div>
                    <?php endif;?>
