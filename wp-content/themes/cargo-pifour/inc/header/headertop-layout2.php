...
?>
<?php if ( is_active_sidebar( 'header-top-2-left' ) || is_active_sidebar( 'header-top-2-right' )  ) : ?>
<div id="header_top" class="header-top layout2">
    <div class="<?php echo esc_attr($container_class);?>">
        <div class="header-top-wrap clearfix">
            <?php if ( is_active_sidebar( 'header-top-2-left' )  ) : ?>
            <div class="header-top-left">
                <?php dynamic_sidebar('header-top-2-left'); ?>
            </div>
            <?php endif;?>
            <?php if ( is_active_sidebar( 'header-top-2-right' )  ) : ?>
            <div class="header-top-right hidden-xs hidden-sm">
                <?php dynamic_sidebar('header-top-2-right'); ?>
            </div>
            <?php endif;?>
        </div>
    </div>
